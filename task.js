...
var storedName = localStorage.getItem('todo');
...
var sub = document.querySelector('.subTaskButton');
...
addingButton.addEventListener('click', function(e){
  ...
  if(input.value.trim()){
    ...
    subtaskButton.onclick = function(){
      ...
      textBox.placeholder="add a subtask";
      liTag.appendChild(brk);
      liTag.appendChild(textBox);
    ...
    buttonDiv.appendChild(subtaskButton);
